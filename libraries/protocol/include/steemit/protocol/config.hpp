...
#define STEEMIT_INIT_PUBLIC_KEY_STR             "EUR81ZR1cVqMWuMGhkXZdh3Sr67Ahwqu7onQb4Rg2me94BMm67cSv"
#define STEEMIT_CHAIN_ID                        (fc::sha256::hash("EFTG"))
#define VESTS_SYMBOL  (uint64_t(6) | (uint64_t('V') << 8) | (uint64_t('E') << 16) | (uint64_t('S') << 24) | (uint64_t('T') << 32) | (uint64_t('S') << 40)) ///< VESTS with 6 digits of precision
#define STEEM_SYMBOL  (uint64_t(3) | (uint64_t('E') << 8) | (uint64_t('F') << 16) | (uint64_t('T') << 24) | (uint64_t('G') << 32)) ///< STEEM with 3 digits of precision
#define SBD_SYMBOL    (uint64_t(3) | (uint64_t('E') << 8) | (uint64_t('U') << 16) | (uint64_t('R') << 24) ) ///< STEEM Backed Dollars with 3 digits of precision
